...
## Logistic Regression
```{r}
lm_fit <- glmnet(as.matrix(X_train),as.factor(Y_train),lambda = best_lambda,alpha=1,family = "multinomial")
Y_hat_logistic <- predict(lasso_bestfit,newx = as.matrix(X_test), s=best_lambda,type = "class")
