...
svm_math <- svm(Student_Class~., data=train_data_math, kernal="radial", gamma=0.1, cost=10) 
summary(svm_math)
```
...
svm_por <- svm(Student_Class~., data=train_data_por, kernal="radial", gamma=0.1, cost=10) 
summary(svm_por)
```
